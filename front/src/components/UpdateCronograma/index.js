...
import { updateCronograma, getCronogramaById } from "../../../services/cronogramaService";
            ...
            const fetchData = async () => {
                try {
                    ...
                    setCronograma({
                        ...
                        tempoAtendimento: cronogramaData.tempoAtendimento,
                        horariosJson: cronogramaData.horariosJson,
                        medico: { id: cronogramaData.medico.id },
                        especialidade: { id: cronogramaData.especialidade.id }
                    });
