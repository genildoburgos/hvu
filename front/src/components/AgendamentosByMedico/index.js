    ...
    const fetchData = async () => {
      try {
        if (id && data) {
          ...
          const filteredAgendamentos = filterAgendamentosByDate(
            agendamentosData,
            data
          );
                  ...
                  <div className={styles.agendamentoBox}>
                    ...
                    <div>
                      ...
                      <h2>
                        {agendamento.agendamento &&
                          agendamento.agendamento.animal &&
                          agendamento.agendamento.animal.nome}
                      </h2>
                    </div>
                    <div>
                      <h1>Especialidade</h1>
                    ...
                    <div>
                      <button
                        ...
                        onClick={() =>
                          router.push(
                            `/getAgendamentoByMedicoById/${agendamento.id}`
                          )
                        }
                      >
                        Visualizar
